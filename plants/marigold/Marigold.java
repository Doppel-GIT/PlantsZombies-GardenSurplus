...
public class Marigold extends EntityModel<Marigold> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData cube_r5 = head.addChild("cube_r5", ModelPartBuilder.create().uv(29, 0).cuboid(-3.0F, -4.0F, 0.0F, 6.0F, 4.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -1.0071F, 0.0133F, -0.7854F, 0.0F, 0.0F));

		ModelPartData cube_r6 = head.addChild("cube_r6", ModelPartBuilder.create().uv(29, 0).cuboid(-3.0F, -4.0F, 0.0F, 6.0F, 4.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.9929F, 0.0133F, -2.3562F, 0.0F, 0.0F));

		ModelPartData cube_r7 = head.addChild("cube_r7", ModelPartBuilder.create().uv(29, 0).cuboid(-3.0F, -4.4142F, -2.4142F, 6.0F, 4.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(1.0F, -0.0071F, 1.4275F, -0.7854F, 0.0F, -1.5708F));

		ModelPartData cube_r8 = head.addChild("cube_r8", ModelPartBuilder.create().uv(29, 0).cuboid(-3.0F, -4.4142F, 2.4142F, 6.0F, 4.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, -0.0071F, 1.4275F, -2.3562F, 0.0F, -1.5708F));
